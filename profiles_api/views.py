...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    queryset = models.ProfileFeedItem.objects.all()  # basic feed up to here. Manages all manage feed items
    permission_classes = (permissions.UpdateOwnStatus, IsAuthenticated)

    # gets called everytime you do a HTTP POST to our view set
